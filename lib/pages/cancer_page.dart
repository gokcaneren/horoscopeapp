...
import 'package:horoscopeapp/pages/cancer_info.dart';
...
class _CancerPageState extends State<CancerPage> {
  ...
  CancerInfo cancer_info=CancerInfo();
  String text='Choose';
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: (){
                        setState(() {
                          text=cancer_info.getCancerInfo();
                        });
                      },
                      child: Container(
                        child: Row(
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: (){
                        setState(() {
                           text=cancer_info.getCancerLove();
                        });
                      },
                      child: Container(
                        child: Row(
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: (){
                        setState(() {
                          text=cancer_info.getCancerAdvise();
                        });
                      },
                      child: Container(
                        child: Row(
